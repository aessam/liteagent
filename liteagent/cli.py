...
Contains the core CLI functions that can be used by both main.py and __main__.py.
"""
...
def run_examples(args):
    ...
    if args.class_methods:
        ...
        from .examples import run_class_methods_example
        ...
        from .examples import run_custom_agents_example
