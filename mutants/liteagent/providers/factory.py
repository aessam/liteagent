...
def x_create_provider__mutmut_orig(model_name, api_key: Optional[str] = None, provider: Optional[str] = None, **kwargs) -> ProviderInterface:
    """
...
# Convenience function for creating providers
def x_create_provider__mutmut_1(model_name, api_key: Optional[str] = None, provider: Optional[str] = None, **kwargs) -> ProviderInterface:
    """
    Convenience function to create a provider.
    ...
    Returns:
        ProviderInterface: The appropriate provider instance
    """
    return ProviderFactory.create_provider(None, api_key, provider=provider, **kwargs)


# Convenience function for creating providers
def x_create_provider__mutmut_2(model_name, api_key: Optional[str] = None, provider: Optional[str] = None, **kwargs) -> ProviderInterface:
    """
    Convenience function to create a provider.
    ...
    Returns:
        ProviderInterface: The appropriate provider instance
    """
    return ProviderFactory.create_provider(model_name, None, provider=provider, **kwargs)


# Convenience function for creating providers
def x_create_provider__mutmut_3(model_name, api_key: Optional[str] = None, provider: Optional[str] = None, **kwargs) -> ProviderInterface:
    """
    Convenience function to create a provider.
    ...
    Returns:
        ProviderInterface: The appropriate provider instance
    """
    return ProviderFactory.create_provider(model_name, api_key, provider=None, **kwargs)


# Convenience function for creating providers
def x_create_provider__mutmut_4(model_name, api_key: Optional[str] = None, provider: Optional[str] = None, **kwargs) -> ProviderInterface:
    """
    Convenience function to create a provider.
    ...
    Returns:
        ProviderInterface: The appropriate provider instance
    """
    return ProviderFactory.create_provider(api_key, provider=provider, **kwargs)


# Convenience function for creating providers
def x_create_provider__mutmut_5(model_name, api_key: Optional[str] = None, provider: Optional[str] = None, **kwargs) -> ProviderInterface:
    """
    Convenience function to create a provider.
    ...
    Returns:
        ProviderInterface: The appropriate provider instance
    """
    return ProviderFactory.create_provider(model_name, provider=provider, **kwargs)


# Convenience function for creating providers
def x_create_provider__mutmut_6(model_name, api_key: Optional[str] = None, provider: Optional[str] = None, **kwargs) -> ProviderInterface:
    """
    Convenience function to create a provider.
...
# Convenience function for creating providers
def x_create_provider__mutmut_7(model_name, api_key: Optional[str] = None, provider: Optional[str] = None, **kwargs) -> ProviderInterface:
    """
    Convenience function to create a provider.
    ...
    Returns:
        ProviderInterface: The appropriate provider instance
    """
    return ProviderFactory.create_provider(model_name, api_key, provider=provider, )

x_create_provider__mutmut_mutants : ClassVar[MutantDict] = {
'x_create_provider__mutmut_1': x_create_provider__mutmut_1, 
    'x_create_provider__mutmut_2': x_create_provider__mutmut_2, 
    'x_create_provider__mutmut_3': x_create_provider__mutmut_3, 
    'x_create_provider__mutmut_4': x_create_provider__mutmut_4, 
    'x_create_provider__mutmut_5': x_create_provider__mutmut_5, 
    'x_create_provider__mutmut_6': x_create_provider__mutmut_6, 
    'x_create_provider__mutmut_7': x_create_provider__mutmut_7
}

def create_provider(*args, **kwargs):
    result = _mutmut_trampoline(x_create_provider__mutmut_orig, x_create_provider__mutmut_mutants, args, kwargs)
    return result 

create_provider.__signature__ = _mutmut_signature(x_create_provider__mutmut_orig)
x_create_provider__mutmut_orig.__name__ = 'x_create_provider'